...
cd ../
Rscript /datacommons/dhvi/mb488/scripts/10x/R/merge_clone_info.R --filtered_contig_annotations ../cellranger_output/all_contig_annotations.all_lanes.umi_filtered.csv
