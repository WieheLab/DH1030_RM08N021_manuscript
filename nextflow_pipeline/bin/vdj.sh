...
# Run cellranger vdj
/datacommons/dhvi/10X_Genomics_data/cellranger/cellranger-${CELLRANGER}/cellranger vdj --id=${SAMPLE_ID} --reference=${REFERENCE} --fastqs=${FASTQS_DIR}/${FASTQ_FOLDER} --sample=${SAMPLE_ID} --chain IG
