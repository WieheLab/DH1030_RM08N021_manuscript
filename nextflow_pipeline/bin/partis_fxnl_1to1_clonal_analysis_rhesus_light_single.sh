...
Rscript /hpc/group/dhvi/WieheLab/scripts/nextflow_pipelines/10x-nextflow-pipeline/bin/all_contig_annots_umi_filter.R -a all_contig_annotations.csv -o all_contig_annotations.umi_filtered.csv
...
-p heavies.fasta \
-c igh \
-g /datacommons/dhvi/Projects/DHVI/Wiehe/Partis_Hash_Create_2024/partis_rhesus10X/BW25_preprint/heavy/_partis_output_igh/hmm/germline-sets \
-w $PARTIS_WORKDIR \
-m /datacommons/dhvi/Projects/DHVI/Wiehe/Partis_Hash_Create_2024/partis_rhesus10X/BW25_preprint/heavy/_partis_output_igh \
-t 10 \
-v | awk '{print $4}')
...
python3 /hpc/group/dhvi/WieheLab/scripts/partis/python_scripts/partis_to_RS_IMGT_hashed_wErr.py -p heavies.partis.annotate.yaml -c heavy -s rhesus -r 1 -n 0
...
-w $PARTIS_WORKDIR \
-t 10 \
-m /datacommons/dhvi/Projects/DHVI/Wiehe/Partis_Hash_Create_2024/partis_rhesus10X/BW25_preprint/heavy/_partis_output_igh | awk '{print $4}')
