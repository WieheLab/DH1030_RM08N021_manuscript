...
-p heavies.fasta \
-c igh \
-g /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/heavy/_partis_output_igh/hmm/germline-sets \
-w $PARTIS_WORKDIR \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/heavy/_partis_output_igh \
-t 10 \
-v | awk '{print $4}')
...
python3 /datacommons/dhvi/scripts/partis/python_scripts/partis_to_RS_IMGT_hashed_wErr.py -p heavies.partis.annotate.yaml -c heavy -s other -a /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/germline_set_IgDiscover_from_Jesse/DH17.IGHV.IgDiscoverHash.yaml -r 1 -n 0
...
-p kappas.fasta \
-c igk \
-g /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/kappa/_partis_output_igk/hmm/germline-sets \
-w $PARTIS_WORKDIR \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/kappa/_partis_output_igk \
-t 10 \
-v | awk '{print $4}')
...
# Convert to SMUA, Recombination Summaries Files
python3 /datacommons/dhvi/scripts/partis/python_scripts/partis_to_RS_IMGT_hashed_wErr.py -p kappas.partis.annotate.yaml -c kappa -s other -a /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/germline_set_IgDiscover_from_Jesse/DH17.IGKV.IgDiscoverHash.yaml -r 1 -n 0 
...
-p lambdas.fasta \
-c igl \
-g /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/lambda/_partis_output_igl/hmm/germline-sets \
-w $PARTIS_WORKDIR \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/lambda/_partis_output_igl \
-t 10 \
-v | awk '{print $4}')
...
# Convert to SMUA, Recombination Summaries Files
python3 /datacommons/dhvi/scripts/partis/python_scripts/partis_to_RS_IMGT_hashed_wErr.py -p lambdas.partis.annotate.yaml -c lambda -s other -a /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/germline_set_IgDiscover_from_Jesse/DH17.IGLV.IgDiscoverHash.yaml -r 1 -n 0 
...
-w $PARTIS_WORKDIR \
-t 10 \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/heavy/_partis_output_igh | awk '{print $4}')
...
-w $PARTIS_WORKDIR \
-t 10 \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/kappa/_partis_output_igk | awk '{print $4}')
...
-w $PARTIS_WORKDIR \
-t 10 \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/DH17/lambda/_partis_output_igl | awk '{print $4}')
