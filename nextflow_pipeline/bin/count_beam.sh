...
/datacommons/dhvi/10X_Genomics_data/cellranger/cellranger-${CELLRANGER}/cellranger count --id=${SAMPLE_ID} --transcriptome=${TRANSCRIPTOME} --libraries=library.csv --feature-ref=${FEATURE_REF}