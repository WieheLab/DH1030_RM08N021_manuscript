...
cp ${LANE_FOLDER}/outs/all_contig* cellranger_output
cd cellranger_output

Rscript /datacommons/dhvi/mb488/scripts/10x/R/all_contig_annots_umi_filter.R -a all_contig_annotations.csv -o all_contig_annotations.umi_filtered.csv
python /datacommons/dhvi/mb488/scripts/10x/python/split_fasta_by_chain_filter_cell_high_conf_CR6.py all_contig_annotations.umi_filtered.csv all_contig.fasta 
...
job_id=$(sbatch /datacommons/dhvi/scripts/partis/job_scripts/partis_flexible_annotate_passParamDir.job \
-p heavies.fasta \
-c igh \
-g /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/heavy/_partis_output_igh/hmm/germline-sets \
-w $PARTIS_WORKDIR \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/heavy/_partis_output_igh \
-t 10 \
-v | awk '{print $4}')
...
python3 /datacommons/dhvi/scripts/partis/python_scripts/partis_to_RS_IMGT_hashed_wErr.py -p heavies.partis.annotate.yaml -c heavy -s other -a /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/germline_set_IgDiscover_from_Jesse/CH21.IGHV.IgDiscoverHash.v3.yaml -r 1 -n 0

# VDJ trimming
Rscript /datacommons/dhvi/scripts/R/scripts/vdjtrimmer.R -s VH_SimpleMarkedUAs.fasta -o heavies.VDJ.fasta

HEAVY_FASTA=$(readlink -f heavies.fasta)
#PARTIS_HEAVY_OUT=$(readlink -f _partis_output_igh)
...
-p kappas.fasta \
-c igk \
-g /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/kappa/_partis_output_igk/hmm/germline-sets \
-w $PARTIS_WORKDIR \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/kappa/_partis_output_igk \
-t 10 \
-v | awk '{print $4}')
...
# Convert to SMUA, Recombination Summaries Files
python3 /datacommons/dhvi/scripts/partis/python_scripts/partis_to_RS_IMGT_hashed_wErr.py -p kappas.partis.annotate.yaml -c kappa -s other -a /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/germline_set_IgDiscover_from_Jesse/CH21.IGKV.IgDiscoverHash.yaml -r 1 -n 0 

# VDJ trimming
Rscript /datacommons/dhvi/scripts/R/scripts/vdjtrimmer.R -s VK_SimpleMarkedUAs.fasta -o kappas.VJ.fasta
...
-p lambdas.fasta \
-c igl \
-g /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/lambda/_partis_output_igl/hmm/germline-sets \
-w $PARTIS_WORKDIR \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/lambda/_partis_output_igl \
-t 10 \
-v | awk '{print $4}')
...
# Convert to SMUA, Recombination Summaries Files
python3 /datacommons/dhvi/scripts/partis/python_scripts/partis_to_RS_IMGT_hashed_wErr.py -p lambdas.partis.annotate.yaml -c lambda -s other -a /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/germline_set_IgDiscover_from_Jesse/CH21.IGLV.IgDiscoverHash.yaml -r 1 -n 0 

# VDJ trimming
Rscript /datacommons/dhvi/scripts/R/scripts/vdjtrimmer.R -s VL_SimpleMarkedUAs.fasta -o lambdas.VJ.fasta
...
job_id=$(sbatch /datacommons/dhvi/scripts/partis/job_scripts/partis_flexible_partition_passParamDir.job \
-p $HEAVY_FASTA \
-c igh \
-g /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/heavy/_partis_output_igh/hmm/germline-sets \
-w $PARTIS_WORKDIR \
-t 10 \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/heavy/_partis_output_igh | awk '{print $4}')
...
python3 /datacommons/dhvi/scripts/partis/python_scripts/get_clones.py -y $ABS_YML -r $ABS_RF 
...
-w $PARTIS_WORKDIR \
-t 10 \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/kappa/_partis_output_igk | awk '{print $4}')
...
-w $PARTIS_WORKDIR \
-t 10 \
-m /datacommons/dhvi/BCR_RepSeq_Data/Monkey_Studies/NHP1010/CH21/lambda/_partis_output_igl | awk '{print $4}')
...
cd ../
Rscript /datacommons/dhvi/srb108/10x-nextflow-pipeline/bin/partis_merge_clone_info.R ../cellranger_output/all_contig_annotations.umi_filtered.csv

cd ../
Rscript /datacommons/dhvi/srb108/10x-nextflow-pipeline/bin/partis_subset_rs_from_merged_clonal_analysis.R
