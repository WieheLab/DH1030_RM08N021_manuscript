...
vdj_new$NewLane <- case_when(vdj_new$lane == '1' ~ '1',
                             vdj_new$lane == '2' ~ '2',
                             vdj_new$lane == '3' ~ '5',
                             vdj_new$lane == '4' ~ '3',
                             vdj_new$lane == '5' ~ '6',
...
gcLN@meta.data$VDJ_data <- ifelse(rownames(gcLN@meta.data) %in% vdj_new$NewBarcode, T, F)
